...
The goal of the repo is to provide the same functions on macOS as on Linux. One exception is that NCCL based distributed GPU training is confirmed not possible on macOS.
